...
$(window).load(function(){
  var $post_para = $(".post-para"),
      ...
      $pre_para.removeClass("invisible"); $digm.text("AARA");
   setTimeout(function(){$pre_para.shuffleLetters({ "text": "Welcome" });$digm.shuffleLetters({ "text": "AARA" });$digm.text("AARA");},1000);
   setTimeout(function(){$pre_para.shuffleLetters({ "text": "to" });$digm.shuffleLetters({ "text": "AARA" });$digm.text("AARA");},2000);


   setTimeout(function(){$pre_para.addClass("invisible");$post_para.fadeIn(600); $digm.text("AARA");},3000);
});
